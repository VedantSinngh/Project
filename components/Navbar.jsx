...
export default function Navbar() {
    ...
    return (
        <header className={`fixed w-full transition-all duration-300 py-4 px-6 z-50 ${
            ...
            <div className="container mx-auto flex justify-between items-center">
                ...
                <Link href="/" className="flex items-center group">
                    ...
                    <div className="flex flex-col">
                        <span className={`font-bold text-xl transition duration-300 ${
                            scrolled ? "text-gray-800" : "text-white"
                        } group-hover:text-blue-600`}>
                            Mindsstate
                        </span>
                        <span className={`text-xs font-medium transition duration-300 ${
                ...
                <nav className="hidden md:flex items-center space-x-8">
                    {["Home", "Properties", "Agents", "Blog"].map((item, index) => (
                        <Link 
                            ...
                            className={`relative font-medium transition-all duration-300 hover:text-blue-600 after:absolute after:w-0 after:h-0.5 after:bg-blue-600 after:bottom-[-4px] after:left-0 after:transition-all after:duration-300 hover:after:w-full ${
                                scrolled ? "text-gray-800" : "text-white"
                            }`}
                        >
                            {item}
                ...
                {/* Mobile Menu */}
                <div className={`fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center transition-all duration-500 ${
